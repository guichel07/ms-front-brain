...
export class DailySalesDB {
  private static instance: DailySalesDB;
  ...
  public static getInstance(): DailySalesDB {
    if (!DailySalesDB.instance) {
      DailySalesDB.instance = new DailySalesDB();
    }
    return DailySalesDB.instance;
  }
